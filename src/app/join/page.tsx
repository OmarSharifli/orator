                        ...
                        {step === 'email' ? (
                            ...
                            >
                                <div className="text-center mb-32">
                                    ...
                                    <p className="text-secondary">Enter the 6-digit code sent to <br /><strong>{email}</strong></p>
                                </div>
                                ...
                                <form onSubmit={handleVerifyCode} className="flex flex-col gap-16">
                                    <input
                                        ...
                                        style={{ fontSize: '1.75rem', letterSpacing: '0.4em', fontWeight: 800, height: '64px' }}
                                        value={code}
